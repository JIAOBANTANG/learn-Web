...
~~~
#### 块级变量
let 可以定义`局部变量`和 `全局变量` let 还可以定义`块级变量`
块级变量就是(只在大括号中生效的变量)
...
console.log( i )   // 10
~~~
*实例2* 使用 var  时无论，调用数组中第几个函数，输出的结果都是10
